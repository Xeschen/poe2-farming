...
작성일: 2026-09-21 · 1차 추출본 · 지도 파밍 6개 + 제작·판매 1개
...
| 서판 제작·판매 | 제작 재료 | 해당 없음 | 해당 없음 | 해당 없음 | 0.5.5 |
...
- **[힐다](https://poe2db.tw/kr/Masters_of_the_Atlas)**: 고유 몬스터 사망 후 혼백 방출 활용 — [혼백의 부름](https://poe2db.tw/kr/Masters_of_the_Atlas)

대가 근거: [14:00](https://www.youtube.com/watch?v=Mi3d9GtgwkI&t=840s) · 전체 선택 조합은 미검증
...
출처: [EasyBabi · 서판 파밍과 제작·판매](https://www.youtube.com/watch?v=rgrR5ty_O9Q) · 2026-09-17 · 패치 0.5.5
...
일반·마법 서판의 속성을 선별한 뒤 가치가 있는 것만 희귀 등급 제작을 이어간다.
...
지도 투입 조합이 아니라 서판 자체를 제작·판매한다.

- 여러 종류의 일반·마법 서판을 제작 재료로 사용한다. 지도에 넣는 서판 조합을 뜻하지 않는다.

근거: [6:02](https://www.youtube.com/watch?v=rgrR5ty_O9Q&t=362s)

### 진행 순서

준비물: 진화의 오브, 확장의 오브, 제왕의 오브, 엑잘티드 오브, 연금술의 오브, 카오스 오브, 신성한 오브.

1. 일반 서판에 진화의 오브와 확장의 오브를 사용해 유효 속성을 확인한다.
2. 좋은 속성이 있으면 제왕의 오브와 엑잘티드 오브로 추가 속성을 붙인다.
3. 가치가 낮으면 연금술의 오브를 사용하는 경로 또는 재련 작업대의 3개 교환을 검토한다.
4. 자본을 더 쓸 경우 카오스 오브 반복 제작을 고려하되 이미 붙은 좋은 속성도 바뀔 수 있음을 반영한다.
5. 신성한 오브로 수치를 높이는 작업은 판매가 차이가 추가 비용보다 클 때만 검토한다.

근거: [6:02](https://www.youtube.com/watch?v=rgrR5ty_O9Q&t=362s)

- 제약: 표시된 판매 희망가와 실제 거래 완료 가격을 구분하고, 제작비·미판매 재고를 함께 계산해야 한다. [6:02](https://www.youtube.com/watch?v=rgrR5ty_O9Q&t=362s)
- **정정:** 영상 설명란은 2:14의 통달한 영토 관련 설명에서 가치 있는 환경을 풀에서 숲으로 정정한다. PoEDB에서 통달한 영토 명칭과 환경별 변형을 확인했다. [출처](https://www.youtube.com/watch?v=rgrR5ty_O9Q)

### 수익 사례와 미확인 사항

영상의 가격 예시는 2026-09-17 당시 설명이며 현재 판매가나 수익 보장으로 사용하지 않는다. [1:36](https://www.youtube.com/watch?v=rgrR5ty_O9Q&t=96s)

- 미확인: 각 서판 속성의 현재 거래 완료 가격
